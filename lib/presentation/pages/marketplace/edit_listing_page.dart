// lib/presentation/pages/marketplace/edit_listing_page.dart
...
class _EditListingPageState extends State<EditListingPage> {
  ...
  void initState() {
    super.initState();
    _businessNameController = TextEditingController(text: widget.listing['businessName'] ?? '');
    ...
    _whatsappController = TextEditingController(text: widget.listing['whatsapp'] ?? '');
    _selectedCategory = widget.listing['category'];
    _selectedArea = widget.listing['area'];
    _selectedHours = widget.listing['hours'];
  }
            ...
            children: [
              // Business Name
                ...
                style: GoogleFonts.outfit(
                  ...
                  color: Color.fromRGBO(11, 11, 11, 0.3),
                ),
              ),
              ...
              // Business Images
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    ...
                    OutlinedButton.icon(
                      onPressed: _pickImages, icon: const Icon(Icons.upload_file,color: Color.fromRGBO(11, 11, 11, 0.45)),

                      label: const Text('Upload',style: TextStyle(fontSize: 16,fontWeight: FontWeight.w400,color: Color.fromRGBO(11, 11, 11, 0.45)),),
                      ...
                      return DropdownMenuItem(
                        ...
                        child: Row(
                          children: [
                            ...
                            Text(category,style: TextStyle(color: Colors.black,fontWeight: FontWeight.w400,fontSize: 16),),
                          ],
                        ),
                      );
                    }).toList(),
              ...
              Container(
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButton<String>(
                    ...
                    hint: Text(
                      'Select Area',
                      style: GoogleFonts.outfit(color: Color.fromRGBO(156, 163, 175, 0.3),fontWeight: FontWeight.w400,fontSize: 16),
                    ),
                    icon: const Icon(Icons.chevron_right, color: AppColors.textHint),
                  ...
                  Expanded(
                    child: RichText(
                      text:   TextSpan(
                        ...
                        style: GoogleFonts.outfit(fontSize: 14,fontWeight: FontWeight.w400,color: AppColors.primary),
                        children: [
                          TextSpan(
                            text: 'estate rules',
                            style: GoogleFonts.outfit(fontSize: 14,fontWeight: FontWeight.w400, color: AppColors.primary),
              ...
              SizedBox(height: 48,
                ...
                child: ElevatedButton(
                  onPressed: _agreedToRules ? _updateListing : null,
  ...
  void _updateListing() {
    if (_formKey.currentState!.validate()) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Listing updated and submitted for review'),
